 ...
 * @author campus
 */
public class TableEmpleoModel extends AbstractTableModel {

    ArrayList<Object[]> datos = new ArrayList<>();
    String[] columns = {"Nombre empleo", "Descripcion"};

    Class[] types = new Class[]{java.lang.String.class, java.lang.String.class};

    public TableEmpleoModel() {

    }

    public TableEmpleoModel(String[] info) {
