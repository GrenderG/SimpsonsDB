 ...
 * @author campus
 */
public class TableLugarModel extends AbstractTableModel {

    ArrayList<Object[]> datos = new ArrayList<>();
    String[] columns = {"Nombre lugar", "Descripcion"};

    Class[] types = new Class[]{java.lang.String.class, java.lang.String.class};

    public TableLugarModel() {

    }

    public TableLugarModel(String[] info) {
